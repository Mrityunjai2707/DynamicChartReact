...
//       case "Bar":
//         return <MyBarChart key={type} />;
//       case "Stacked":
//         return <MyBarChart stacked key={type} />;
//       default:
//         return <MyLineChart />;
//     }
//   };
...
//           <LineChart>{this.getLineChart()}</LineChart>
//         </Brush>
//       </LineChart>
//       //  </ResponsiveContainer>
//     );
...
const Chart = ({ type }) => {
  ...
  const handleFormatter = (value, name) => {
    const nameJSX = (
      <span>
        <span
          style={{
            ...
            width: "10px",
            height: "10px",
            backgroundColor: formatterProps.color,
          }}
        ></span>
        {name} : {value}
      </span>
